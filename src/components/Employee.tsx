...
export default function Employee({
  ...
  // 팀별 색상 가져오기 (기본값은 회색)
  const badgeColor =
    teamColors[employeeData.department] ||
  ...
  return (
    <div
      ...
      `}
    >
      <Badge className={`text-[10px] min-w-[50px] text-center ${badgeColor}`}>
        {employeeData.department}
      </Badge>
      <span className="text-[15px]">
        {employeeData.gender === "male" ? "🧑‍💼" : "👩‍💼"}
      </span>
      <span className="text-[10px] font-bold text-center text-nowrap">
